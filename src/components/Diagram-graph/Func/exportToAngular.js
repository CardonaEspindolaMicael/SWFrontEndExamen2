import { pnpmyalm } from "./pnpmyaml";

export const angularFile = {
  'tsconfig.json': `
...
export const generateAngularFiles = (pagesData) => {
...
export const routes: Routes = [
  ...
  { path: '', redirectTo: 'shop', pathMatch: 'full' },
    ...
    generatedFiles['src/core/components/nav-bar.component.html'] = `<div class="flex justify-center gap-4 my-4">
  <button class="px-4 py-2 text-white bg-blue-500 rounded-md shadow-md hover:bg-blue-600 transition-all" routerLink="hola-mundo" routerLinkActive="btn-active">hola mundo</button>
</div>`;
  }
...
function generateNavbar(newComponents) {
  let navbarHtml = `<div class="flex justify-center gap-4 my-4">
  <button class="px-4 py-2 text-white bg-blue-500 rounded-md shadow-md hover:bg-blue-600 transition-all" routerLink="hola-mundo" routerLinkActive="btn-active">hola mundo</button>`;

  // Añadir botones para nuevos componentes
  newComponents.forEach(comp => {
    const displayName = comp.path.replace(/-/g, ' ');
    navbarHtml += `\n  <button class="px-4 py-2 text-white bg-blue-500 rounded-md shadow-md hover:bg-blue-600 transition-all" routerLink="${comp.path}" routerLinkActive="btn-active">${displayName}</button>`;
  });
