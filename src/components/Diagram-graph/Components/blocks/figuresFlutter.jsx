...

{
  ...
  attributes: { class: "gjs-block-section" },
  content: `<body>
  <div class="max-w-sm mx-auto h-screen bg-white rounded-2xl shadow-md overflow-hidden mt-4">

    <!-- Header -->
    <div class="bg-primary text-on-primary p-4 rounded-t-2xl">
      <div class="flex items-center justify-between">
        <div class="flex items-center">
          <button class="mr-4 focus:outline-none">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" class="h-6 w-6">
    ...
    <div class="p-4">
      <div class="flex items-center">
        ...
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" class="h-6 w-6 ml-2 text-blue-500">
          ...
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7 1.274 4.057-1.512 9-5.458 9-3.947 0-6.733-4.943-8.007-9z"></path>
        </svg>
      </div>
    </div>
    ...
    <div class="flex flex-col justify-between p-4">
      <!-- Task -->
      <div class="bg-surface-variant text-on-surface-variant rounded-2xl p-4 mb-2 shadow-sm">
        <div class="flex items-center justify-between mb-2">
          <div>
            <div class="flex items-center">
              <div class="rounded-full bg-green-400 w-2 h-2 mr-2"></div>
          ...
          <div>
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"
              class="h-6 w-6 inline-block text-on-surface-variant">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-6-6c-2.475 0-4.544 1.977-5.352 4.627A6.004 6.004 0 004 11v3.158c0 .538-.214 1.055-.595 1.436L4 17h5">
              </path>
            </svg>
      ...
      <div class="flex items-end space-x-4 w-full max-w-md">
        <div class="flex-1 flex flex-col">
          ...
          <input id="elemento" type="text" placeholder="" class="w-full bg-transparent border-b border-gray-300 text-[#1C1B1F] placeholder-[#7A7580] focus:outline-none focus:border-[#6750A4] focus:ring-0 pb-1" />
        </div>
        <button type="button" class="bg-blue-500 text-white font-medium rounded-full px-4 py-2 shadow-sm">
          Agregar
        </button>
      </div>

      <!-- Table -->
      <div class="overflow-x-auto rounded-2xl shadow-md mt-4">
        <table class="min-w-full divide-y divide-gray-200">
          <!-- Encabezado -->
          <thead class="bg-primary-container">
            <tr>
              <th class="px-6 py-3 text-left text-sm font-semibold text-on-primary-container">ID</th>
              <th class="px-6 py-3 text-left text-sm font-semibold text-on-primary-container">Nombre</th>
              <th class="px-6 py-3 text-left text-sm font-semibold text-on-primary-container">Edad</th>
              <th class="px-6 py-3 text-left text-sm font-semibold text-on-primary-container">Email</th>
            </tr>
          </thead>
          <!-- Filas -->
          <tbody class="bg-surface divide-y divide-gray-200">
            <tr class="hover:bg-secondary-container hover:text-on-secondary-container transition-colors">
              <td class="px-6 py-4 whitespace-nowrap text-sm">1</td>
              <td class="px-6 py-4 whitespace-nowrap text-sm">Ana Pérez</td>
              <td class="px-6 py-4 whitespace-nowrap text-sm">28</td>
              <td class="px-6 py-4 whitespace-nowrap text-sm">ana.perez@mail.com</td>
